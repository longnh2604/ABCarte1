...
static NSString *API_CAMERA_setExposureMode = @"setExposureMode";
#define API_CAMERA_setTouchAFPosition       @"setTouchAFPosition"
#define API_CAMERA_cancelTouchAFPosition    @"cancelTouchAFPosition"
#define API_CAMERA_getTouchAFPosition       @"getTouchAFPosition"
#define API_CAMERA_setStillSize             @"setStillSize"
#define API_CAMERA_getStillSize             @"getStillSize"
#define API_CAMERA_getAvailableStillSize    @"getAvailableStillSize"
#define API_CAMERA_setPostviewImageSize     @"setPostviewImageSize"
#define API_CAMERA_setExposureCompensation  @"setExposureCompensation"
...
#define PARAM_CAMERA_cameraStatus_idle              @"IDLE"
#define PARAM_CAMERA_cameraStatus_stillCapturing    @"StillCapturing"
#define PARAM_CAMERA_cameraStatus_notReady          @"NotReady"
